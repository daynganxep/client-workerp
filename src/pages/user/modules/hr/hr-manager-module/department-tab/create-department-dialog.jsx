...
function CreateDepartmentDialog({ refetch }) {
    ...
    const mutation = useMutation({
        mutationFn: async (data) => {
            const [res, err] = await DepartmentService.createDepartment(data);
    ...
    return (
        <FormDialog
            title="working.hr.department.create-department"
            ...
            triggerButton={<Button
                ...
                startIcon={<Add />}
            >
                {t("working.hr.department.create-department")}
            </Button>}
        >
            <TextField
                fullWidth
